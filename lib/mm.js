...
var MM = {
    ...
    _defaultErrorFunction: function(xhr, textStatus, errorThrown) {
        var error = MM.lang.s('cannotconnect') + " 184";
        if (xhr.status == 404) {
    ...
    saveSite: function(username, password, siteurl, originalProtocol) {
        ...
        $.ajax({
            ...
            error:function(xhr, textStatus, errorThrown) {
                var error = MM.lang.s('cannotconnect') + " 829";
    ...
    moodleWSCall: function(method, data, callBack, preSets, errorCallBack) {
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                if (!data) {
                    if (errorCallBack) {
                        ...
                        MM.popErrorMessage(MM.lang.s("cannotconnect") + " 1119");
                    }
                    return;
                }
            ...
            error: function(xhr, ajaxOptions, thrownError) {
                ...
                var error = MM.lang.s('cannotconnect') + " 1181";
                if (xhr.status == 404) {
                    error = MM.lang.s('invalidscheme');
                }
                if (!preSets.silently) {
